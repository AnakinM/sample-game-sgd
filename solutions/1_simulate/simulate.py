...
def showGameOverScreen():
    DISPLAYSURF.fill(bgColor)
    gameOverSurf = BASICFONT.render("Game Over! Press any key to restart.", 1, WHITE)
...
def main():
    ...
    score = 0
    # when False, the pattern is playing. when True, waiting for the player
    # to click a colored button:
